...
round8_finnish_variable_names <- c("syy","vastuu","hallitus","sukupuoli","ika","koulutus","tulot","politiikka")

colnames(round8_subset) <- round8_new_variable_names

# Ja käännetään levelit suomeksi
personal_responsibility_finnish_levels <- levels(round8_subset$personal_responsibility)
personal_responsibility_finnish_levels[1] <- "En lainkaan"
personal_responsibility_finnish_levels[11] <- "Hyvin paljon"
levels(round8_subset$personal_responsibility) <- personal_responsibility_finnish_levels
```
...
Havainto kyseisestä muuttujasta puuttuu $34$ tilastoyksiköltä. Kun tarkastellaan ... tukee pudottamista. 

MissMech: An R Package for Testing Homoscedasticity, Multivariate Normality, and
Missing Completely at Random (MCAR)
Mortaza Jamshidian 2014
Journal of Statistical Softwares
January 2014, Volume 56, Issue 6.
...
Kun aineistosta on pudotettu puuttuvat havainnot, havaitaan, että aineiston mukaan suomalaiset tuntevat keskimääräisesti (vastausten ka. $`r round(mean(as.numeric(round8_subset[,2])),2)`$) paljon vastuuta ilmastonmuutoksen ehkäisemisestä (kts. Kaavio 1). 
...
vaikutusta henkilökohtaisen ilmastovastuun kokemiseen.  Muuttujien välistä korrelaatiota (Taulukko 1) tarkastelemalla havaitaan, TODO: JOTAIN ETTÄ PIDETÄÄN YKSINKERTAISENA. Korrelaatiotarkastelua ei nyt varmaan tällaisilla muuttujilla tarvita?

Koska ... vähennetään luokkia. Molemmat muuttujat ordinaalisia, 
...
kable(round(cor(round8_numeric),3), caption="Taulukko 1: Muuttujien väliset korrelaatiot.")
