...
```{r}
# Muuttujien välisen korralaation tarkastelu (lähinnä taustamuuttujien tarkastelua varten)
cor(round8_numeric)
```
...
Tutkitaan lisäksi taustamuuttujien vaikutusta, 
ikä, koulutus, sukupuoli, poliittinen suuntautuminen
