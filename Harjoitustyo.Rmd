...
mukaan suomalaiset tuntevat keskimääräisesti (vastausten ka. $`r round(mean(round8_subset$personal_responsibility),2)`$) vastuuta ilmastonmuutoksen ehkäisemisestä. 
...
* **Ikä**. Jatkuva, numeerinen. Vaihteluväli ...
* **Sukupuoli**. Kaksiluokkainen, kategorinen.
* **Koulutus**. Tsiljoonaluokkainen
