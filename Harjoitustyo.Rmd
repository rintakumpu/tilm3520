...
Kun tarkastellaan henkilökohtaista ilmastovastuuta muiden muuttujien suhteen eri luokkien suhteen ennen kuin myös vastemuuttujan luokkia vähennetään (Taulukot) huomataan että HALLITUS ja 
...
ggplot(data=round8_numeric[round8_numeric$government_action==1,], aes(round8_numeric[round8_numeric$government_action==1,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 1") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=12), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$government_action==2,], aes(round8_numeric[round8_numeric$government_action==2,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 2") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$government_action==3,], aes(round8_numeric[round8_numeric$government_action==3,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 3") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))
```
...
```{r fig.width=2, fig.height=2}
ggplot(data=round8_numeric[round8_numeric$caused_by==1,], aes(round8_numeric[round8_numeric$caused_by==1,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 1") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$caused_by==2,], aes(round8_numeric[round8_numeric$caused_by==2,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 2") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$caused_by==3,], aes(round8_numeric[round8_numeric$caused_by==3,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 3") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))
```
...
```{r fig.width=2, fig.height=2}
ggplot(data=round8_numeric[round8_numeric$age==1,], aes(round8_numeric[round8_numeric$age==1,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 1") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$age==2,], aes(round8_numeric[round8_numeric$age==2,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 2") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$age==3,], aes(round8_numeric[round8_numeric$age==3,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 3") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$age==4,], aes(round8_numeric[round8_numeric$age==4,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Luokka 4") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))
```
...
```{r fig.width=2, fig.height=2}
ggplot(data=round8_numeric[round8_numeric$gender==1,], aes(round8_numeric[round8_numeric$gender==1,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Mies") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))

ggplot(data=round8_numeric[round8_numeric$gender==2,], aes(round8_numeric[round8_numeric$gender==2,]$personal_responsibility))+ labs(title="", x="", y="f", caption="Nainen") + geom_bar(fill="steelblue") + theme(plot.title = element_text(size=6), plot.caption = element_text(size=8))
...
Seuraavaksi siirrymme mallintamaan ja tarkastelemaan havaittujen erojen tilastollista merkitsevyyttä (sekä mahdollisia eroja muuttujien yhdysvaikutuksissa).
