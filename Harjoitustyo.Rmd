...
Havainto kyseisestä muuttujasta puuttuu $34$ tilastoyksiköltä.

MissMech: An R Package for Testing
Homoscedasticity, Multivariate Normality, and
...
mukaan suomalaiset tuntevat keskimääräisesti (vastausten ka. $`r round(mean(as.numeric(round8_subset[,2])),2)`$) vastuuta ilmastonmuutoksen ehkäisemisestä. 
...
Muuttujien välistä korrelaatiota () tarkastelemalla
...
kable(round(cor(round8_numeric),3))
