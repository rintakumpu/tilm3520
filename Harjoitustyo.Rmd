...
CrossTable(round8_numeric$personal_responsibility,round8_numeric$government_action,digits=2,prop.t = TRUE,prop.chisq =  FALSE, format = "SPSS")
CrossTable(round8_numeric$personal_responsibility,round8_numeric$gender,digits=2,prop.t = TRUE,prop.chisq =  FALSE, format = "SPSS")
CrossTable(round8_numeric$personal_responsibility,round8_numeric$age,digits=2,prop.t = TRUE,prop.chisq =  FALSE, format = "SPSS")
CrossTable(round8_numeric$personal_responsibility,round8_numeric$caused_by,digits=2,prop.t = TRUE,prop.chisq =  FALSE, format = "SPSS")
```
...
muuttujat <- c("AIC","BIC","Deviance","LogLikelihood")
mallit <- c("Cumulative logit","Adjacent-categories logit","Continuation-Ratio logit","Cumulative probit","Cumulative clog-log")
